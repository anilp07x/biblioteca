    ...
    <div class="row page-titles mx-0">
        <div class="col p-md-0">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="javascript:void(0)">Listar Categorias</a></li>
                <li class="breadcrumb-item active"><a href="javascript:void(0)">Inserir Categorias</a></li>
            </ol>
        </div>
    </div>
    <!-- row -->
                    ...
                    <div class="card-body">
                        ...
                        <?php
                            ...
                            if(!empty($dados['enviar'])){
                                ...
                                $query_usuario = "INSERT INTO categoria (nome_categoria) VALUES (:nome)";
                                ...
                                header("Location: categoria.php");
                                    ...
                                    echo "<p style='color: #f00;'>Erro: Categoria não cadastrado!</p>";
                                }
                            }
                        ...
                        ?>
                            <form method="post">
                                ...
                                <h4 class="card-title">Inserir Categorias | <a href="categoria.php">Listar Categorias</a></h4>
                                    <div class="row">
